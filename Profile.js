...
async function loadMathSprintStats(userId) {
  try {
    ...
    if (!sprintSnap.exists()) {
      document.getElementById("sprintTotalMatches").textContent = "0";
      document.getElementById("sprintHighScore").textContent = "0";
      return;
    }
    ...
    document.getElementById("sprintTotalMatches").textContent = matchesPlayed.toString();
    document.getElementById("sprintHighScore").textContent = bestScore.toString();
